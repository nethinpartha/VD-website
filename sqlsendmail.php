...
<?php
  ...
  require 'vendor/phpmailer/phpmailer/src/SMTP.php';
    ...
    if(isset($_POST['submit5'])){
        $name=$_POST['name5']; // Get Name value from HTML Form
        $mobile=$_POST['phone5'];  // Get Mobile No
        $email=$_POST['mail5'];  // Get Email Value
        $message=$_POST['companyname5']; // Get Message Value
...
<div class="modal modal-auto-clear8" tabindex="-1" id="modal13">
...
<script>
        $('.modal-auto-clear8').on('shown.bs.modal', function () {
