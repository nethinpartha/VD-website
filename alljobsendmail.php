  ...
  require 'vendor/phpmailer/phpmailer/src/SMTP.php';
    ...
    if(isset($_POST['careersubmit'])){
        ...
        if (array_key_exists('attachment', $_FILES)) {
            ...
            $uploadfile = $_SERVER['DOCUMENT_ROOT'].'Mail/assets/files/'.$img_name;
            if (move_uploaded_file($_FILES['attachment']['tmp_name'], $uploadfile)) {
                    ...
                    $mail->addAddress("refer@vuedata.in");
                    $mail->IsHTML(true);
                    //$mail->AddAttachment($filename);
                    $mail->addAttachment($uploadfile, 'My uploaded resume');
                    $mail->Subject = 'Career';
...
<div class="modal modal-auto-clear-career" tabindex="-1" id="modalcareer">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <h3 class="text-center p-3" style="background-color: blanchedalmond;">Thank you for the details !<i class="ps-3 fas fa-child"></i></h3>
...
<script>
        $('.modal-auto-clear-career').on('shown.bs.modal', function () {
