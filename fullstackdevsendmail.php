    ...
    if(isset($_POST['careersubmit'])){
        ...
        if (array_key_exists('attachment', $_FILES)) {
            ...
            if (move_uploaded_file($_FILES['attachment']['tmp_name'], $uploadfile)) {
                    ...
                    $mail->addAttachment($uploadfile, 'Full Stack Developer Resume' . '.' . $extension);
                    $mail->Subject = 'Career';
...
<div class="modal modal-auto-clear-fullstack" tabindex="-1" id="modalfullstack">
...
<script>
        $('.modal-auto-clear-fullstack').on('shown.bs.modal', function () {
                                    $(this).delay(5000).fadeOut(200, function () {
                                        $(this).modal('hide');
                                        window.location.href = 'full-stack-developer-campaign.html';
                                    });
                                  })
    </script>
</body>
