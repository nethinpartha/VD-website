...
<?php
  ...
  require 'vendor/phpmailer/phpmailer/src/SMTP.php';
    ...
    if(isset($_POST['submit3'])){
        $name=$_POST['name3']; // Get Name value from HTML Form
        $mobile=$_POST['phone3'];  // Get Mobile No
        $email=$_POST['mail3'];  // Get Email Value
        $message=$_POST['companyname3']; // Get Message Value
...
<div class="modal modal-auto-clear6" tabindex="-1" id="modal11">
        <div class="modal-dialog modal-dialog-centered modal-xls">
          <div class="modal-content">
           
            <div class="modal-body p-0">
            <h3 class="text-center p-3" >Thank you for the details !<i class="ps-3 fas fa-child"></i></h3>
...
<script>
        $('.modal-auto-clear6').on('shown.bs.modal', function () {
                                    $(this).delay(5000).fadeOut(200, function () {
                                        $(this).modal('hide');
                                        window.location.href = '/solutions/media-case-study.pdf';
                                    });
                                  })
    </script>
</body>
