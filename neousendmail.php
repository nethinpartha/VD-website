...
<?php
  ...
  require 'vendor/phpmailer/phpmailer/src/SMTP.php';
    ...
    if(isset($_POST['submit4'])){
        $name=$_POST['name4']; // Get Name value from HTML Form
        $mobile=$_POST['phone4'];  // Get Mobile No
        $email=$_POST['mail4'];  // Get Email Value
        $message=$_POST['companyname4']; // Get Message Value
...
<div class="modal modal-auto-clear7" tabindex="-1" id="modal12">
...
<script>
        $('.modal-auto-clear7').on('shown.bs.modal', function () {
