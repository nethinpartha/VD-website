...
<?php
  ...
  require 'vendor/phpmailer/phpmailer/src/SMTP.php';
    ...
    if(isset($_POST['submit1'])){
        $name=$_POST['name1']; // Get Name value from HTML Form
        $mobile=$_POST['phone1'];  // Get Mobile No
        $email=$_POST['mail1'];  // Get Email Value
        $message=$_POST['companyname1']; // Get Message Value
...
<div class="modal modal-auto-clear4" tabindex="-1" id="modal9">
...
<script>
        $('.modal-auto-clear4').on('shown.bs.modal', function () {
                                    $(this).delay(5000).fadeOut(200, function () {
                                        $(this).modal('hide');
                                        window.location.href = '/solutions/retail-case-study.pdf';
                                    });
                                  })
    </script>
</body>
